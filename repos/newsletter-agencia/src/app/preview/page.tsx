...
export default async function PreviewPage() {
  try {
    ...
    const message = error instanceof Error ? error.message : "Falha inesperada ao carregar o preview";
    ...
    return (
      <div className="space-y-6">
        <section className="card p-6">
          ...
          <p className="mt-4 rounded-lg bg-red-50 p-3 text-sm font-semibold text-red-700">{message}</p>
